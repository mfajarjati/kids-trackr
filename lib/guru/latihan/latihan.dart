...
class _LatihanGuruState extends State<LatihanGuru> {
  ...
  final _pilihanBenarController = TextEditingController();
  ...
  void dispose() {
    ...
    _pilihanBenarController.dispose();
  ...
  void _saveForm() {
    if (_formKey.currentState!.validate()) {
      final correctAnswer = _pilihanBenarController.text;
      final pilihanA = _pilihanAController.text;
      final pilihanB = _pilihanBController.text;
      final pilihanC = _pilihanCController.text;
      final pilihanD = _pilihanDController.text;

      if ([pilihanA, pilihanB, pilihanC, pilihanD].contains(correctAnswer)) {
        // All fields are valid and the correct answer matches one of the options
        ...
        Fluttertoast.showToast(
          msg:
              "Pilihan benar harus sesuai dengan salah satu pilihan A, B, C, atau D",
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.CENTER,
          timeInSecForIosWeb: 1,
          textColor: Colors.white,
                            ...
                            _isLoading
                                ...
                                : Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 2.h),
                                      TextFormField(
                                        controller: _pilihanBenarController,
                                        decoration: const InputDecoration(
                                          labelText: 'Pilihan benar',
                                          border: OutlineInputBorder(),
                                        ),
                                        maxLines: 1,
                                        validator: (value) {
                                          if (value == null || value.isEmpty) {
                                            return 'Pilihan benar tidak boleh kosong';
                                          }
                                          return null;
                                        },
                                      ),
