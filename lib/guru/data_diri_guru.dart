...
class DataDiriGuru extends StatefulWidget {
  const DataDiriGuru({super.key});
  static String routeName = 'DataDiriGuru';

  @override
  // ignore: library_private_types_in_public_api
  _DataDiriGuruState createState() => _DataDiriGuruState();
}

class _DataDiriGuruState extends State<DataDiriGuru> {
